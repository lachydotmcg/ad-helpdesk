...
| **DESTRUCTIVE** | `disable_account`, `bulk_move_users`, `create_ou` (6-digit token-gated); `move_user`, `create_user`, `remove_from_group` (flow-confirmed) | **Never** auto-resolved — a human always approves |
