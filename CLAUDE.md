# AD Helpdesk — Project Brief for Claude Code
...
- Janus AI chat (`/dashboard/chat`) — Claude Haiku with tool-use style prompting
...
| `ANTHROPIC_API_KEY` | Claude Haiku for Janus |
